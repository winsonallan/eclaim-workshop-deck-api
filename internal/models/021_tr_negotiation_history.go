...
type NegotiationHistory struct {
	...
	ProposedMeasurementNo  *uint      `gorm:"type:int(11);null" json:"proposed_measurement_no"`
	...
	NegotiationPhotos    []NegotiationPhotos `gorm:"foreignKey:NegotiationHistoryNo;references:NegotiationHistoryNo" json:"negotiation_photos,omitempty"`
