...
type WorkshopPics struct {
	WorkshopPicNo     uint      `gorm:"primaryKey;column:workshop_pic_no;type:int(11);autoIncrement" json:"workshop_pic_no"`
	...
	WorkshopPicTitle  string    `gorm:"not null;type:varchar(50)" json:"workshop_pic_title"`
